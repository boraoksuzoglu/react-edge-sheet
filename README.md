...
| `containerClassName`    | `string`                                 | —               | CSS class for full-screen overlay (portal root)                  |
| `containerStyle`        | `React.CSSProperties`                    | —               | Styles merged onto overlay container                             |
| `innerWrapperClassName` | `string`                                 | —               | Animate-size inner wrapper (see docs; only some configurations)  |
| `innerWrapperStyle`     | `React.CSSProperties`                    | —               | Styles merged onto animate-size inner wrapper                    |
...
| `scrollLock`            | `boolean`                                | `true`          | Lock body scroll while open; false = page stays scrollable       |
| `scrollLockPadding`     | `boolean \| string`                      | `true`          | Body padding during scroll lock (ignored if scrollLock is false) |

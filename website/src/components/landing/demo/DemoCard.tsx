  ...
  return (
    <button
      ...
      style={{
        ...
        background: 'color-mix(in oklch, var(--glass-surface) 75%, transparent)',
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = `0 20px 40px -12px rgba(0,0,0,0.18), 0 0 0 1px color-mix(in oklch, ${accent} 30%, transparent)`;

				...
				{shareOptions.map((opt) => (
					<button
						...
						onMouseLeave={(e) => {
							...
							e.currentTarget.style.borderColor = "color-mix(in oklch, var(--glass-border) 45%, transparent)";
							e.currentTarget.style.background = "color-mix(in oklch, var(--glass-surface) 55%, transparent)";
						}}
					>
						<div
							style={{

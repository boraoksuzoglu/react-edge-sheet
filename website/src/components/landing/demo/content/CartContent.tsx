		...
		<div style={{ padding: "1.5rem 1.75rem", minWidth: 0, maxWidth: "100%" }}>
			...
			>
				...
				<button
					...
					onMouseEnter={(e) => {
						e.currentTarget.style.background = "color-mix(in oklch, var(--glass-border) 60%, transparent)";
					}}
					onMouseLeave={(e) => {
						e.currentTarget.style.background = "color-mix(in oklch, var(--glass-border) 40%, transparent)";
					}}
				>
					✕
				</button>

...
const features = [
  {
    ...
    title: 'All 4 Edges',
    description: 'Panels from top, bottom, left, or right. Just pass the `edge` prop and you\'re done.',
  ...
  },
  {
    ...
    title: 'Dual API',
    description: 'Controlled via `open` prop or imperative via `ref.current.open()` — pick what fits your code.',
  ...
  },
  {
    ...
    description: '~4 kB gzipped. No lodash, no framer-motion, no emotion. Just React and your styles.',
          ...
          {features.map((feature) => (
            <GlassCard key={feature.title} className="flex flex-col gap-4 !p-5">
              <div
                ...
                style={{ color: feature.color, backgroundColor: `color-mix(in oklch, ${feature.color} 12%, transparent)` }}
              >
                {feature.icon}
              </div>
              <div>

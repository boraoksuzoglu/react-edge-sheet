...
const DEMO_CARDS = [
  ...
  { refKey: 'glass', icon: '◇', title: 'Glass', sub: 'Now playing', accent: 'oklch(65% 0.22 290)' },
  {
    ...
    icon: '☑',
    title: 'Task List',
    sub: 'Add/remove items',
    accent: 'oklch(60% 0.22 145)',
  },
  {
    refKey: 'dynamicFaq',
    icon: '?',
    title: 'FAQ',
    sub: 'Expand to resize',
    accent: 'oklch(58% 0.20 280)',
  },
  {
    refKey: 'dynamicNotes',
    icon: '✎',
    title: 'Quick Notes',
    sub: 'Notes grow sheet',
    accent: 'oklch(62% 0.20 85)',
  },
  {
    refKey: 'controlled',
    icon: '⊙',
    ...
    <section className="py-20 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <Sheet
          ref={topRef}
          edge="top"
          style={floatStyle(isMobile ? { padding: 0, width: '100%' } : { padding: 0 }, {
            isMobile,
            edge: 'top',
          })}
          maxWidth={isMobile ? '100%' : '500px'}
        ...
        <Sheet
          ref={leftRef}
          edge="left"
          style={floatStyle(isMobile ? { width: '100%', borderRadius: 0 } : { width: 260 })}
        >

...
function buildSheetStyle(): React.CSSProperties {
  return {
    ...
    boxShadow:
      '0 32px 80px -16px rgba(0,0,0,0.25), 0 0 0 1px color-mix(in oklch, var(--glass-border) 25%, transparent)',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            fontFamily: 'inherit',
            boxShadow: '0 4px 12px -2px oklch(68% 0.22 290 / 0.3)',
        ...
        <span
          style={{ fontSize: '0.8rem', color: 'var(--foreground-muted)', fontFamily: 'monospace' }}
        >
          animationPreset=&quot;{active}&quot;
        </span>
      </div>

      <Sheet ref={ref} edge="bottom" animationPreset={active} style={buildSheetStyle()}>
        <div style={pill} />
        <div
          style={{
            fontSize: '0.7rem',
        ...
        >
          {PRESETS.find((p) => p.id === active)?.desc} — close and reopen to compare with a
          different preset.
        </p>
        <button
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
        <button
          ...
          style={{
            ...
            border: 'none',
            background:
              'linear-gradient(135deg, var(--color-atmos-indigo), var(--color-atmos-purple))',
            color: '#fff',
            cursor: 'pointer',
            fontSize: '0.875rem',
            fontWeight: 600,
        ...
        <span style={{ fontSize: '0.78rem', color: 'var(--foreground-muted)' }}>{preset.desc}</span>
      </div>
        ...
        >
          <code
            style={{
              ...
              background: 'color-mix(in oklch, var(--color-atmos-indigo) 8%, transparent)',
          ...
          <code
            style={{
              ...
              background: 'color-mix(in oklch, var(--color-atmos-purple) 8%, transparent)',
              padding: '0.25rem 0.625rem',
              borderRadius: '0.375rem',
            }}
          >
